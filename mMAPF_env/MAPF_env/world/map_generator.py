...
class maze_generator():
    def __init__(self, env_size=(10, 15), wall_components=(1, 8), obstacle_density=None,
                 go_straight=0.8):
...
#            plt.show()
    ...
    def generator(self):
        ...
        # obstacle_density[1])
        self.world_size = np.random.randint(self.min_size, self.max_size + 1)
        world = -self.maze(int(self.world_size), int(self.world_size),
